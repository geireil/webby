...
var btn = document.getElementById("todoBtn"); // Get the <span> element that closes the modal
...
function updateClickListeners() {
  ...
  var myDeleteFunction = function () {
    let id = event.target.id; //document.getElementById("logo").innerHTML = "HIOF - deleteId: " + id;
  ...
  var myCompleteFunction = function () {
    let id = event.target.id; //document.getElementById("logo").innerHTML = "HIOF - completeId: " + id;
    ...
    todosArray.splice(id, 1);
    showCards();
    showList(); //document.getElementById("logo").innerHTML = "HIOF - compTodosArrLength: " + completedTodosArray.length;
  };
